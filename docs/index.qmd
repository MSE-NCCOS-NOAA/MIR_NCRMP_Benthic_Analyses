...
if (knitr::is_html_output()) {
  ...
  cat(TableCaption)
  cat("![Number of demographic (Demo) and benthic community assessment (BCA) surveys completed by M:IR, NCRMP, and DRM in 2022 and 2024](../Project/images/Proper_Table.png){ width=100% }")
}
```
